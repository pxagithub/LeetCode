...
namespace LCP_13.Treasure_hunt
{
    class Program
    {
        /*LCP 13. 寻宝
        ...
        static void Main(string[] args)
        {
            ...
            string[] y = { "S#O", "M.#", "M.T" };
            string[] z = { "S#O", "M.T", "M.." };
            Console.WriteLine(string.Join(",",MinimalSteps(x),MinimalSteps(y),MinimalSteps(z)));
        ...
        private static int[][] Bfs( int x,  int y, string[] maze)
        {
            int[][] ret=new int[n][];
            for (int i = 0; i < n; i++)
            {
        ...
        private static bool InBound(in int x, in int y)
        {
